...
$consulta = "SELECT s.MotFini, s.MotFfin , MotCodOdt, s.MotDescrip, s.MotNroElem, s.MotCodMaq ,s.MotTirRet ,s.MotTipoMaq ,s.SecuencyMachine, s.MotPliegos ,s.MotCant, s.MotEstado, s.MotNroComplem 
